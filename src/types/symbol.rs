...
impl SymbolTable {
  ...
  pub fn initialize() -> LinkedHashMap<String, Symbol> {
    ...
    symbols.insert(String::from("int"), Symbol::new("int", SymbolType::Int, true));
    symbols.insert(String::from("float"), Symbol::new("float", SymbolType::Float, true));
    symbols.insert(String::from("string"), Symbol::new("string", SymbolType::String, true));
